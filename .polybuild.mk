...
cpp_compilation_flags := -Wall -std=c++17 -O3 -pthread $(dynamic_flag)
...
ifeq ($(OS),Windows_NT)
	...
	cpp_compiler := $(CXX)
	c_compilation_flags := $(CFLAGS) $(dynamic_flag)
	cpp_compilation_flags := /W3 /std:c++20 /EHsc /I"$(OPENSSL_ROOT_DIR)"/include /O2 $(dynamic_flag)
...
securitas$(out_ext): obj/main_0$(obj_ext) obj/client_0$(obj_ext) obj/server_0$(obj_ext) obj/websocket_0$(obj_ext) obj/string_0$(obj_ext) obj/polyweb_0$(obj_ext) obj/polynet_0$(obj_ext) obj/secure_sockets_0$(obj_ext) $(static_libraries)
	@printf "\033[1m[POLYBUILD]\033[0m %s\n" "Building $@..."
